...
# TextBugger Attack Recipe
attack = textattack.attack_recipes.TextBuggerLi2018.build(model_wrapper)

attack_args = textattack.AttackArgs(
    num_examples=1000,
    log_to_csv="results_textbugger.csv",
    checkpoint_interval=100,
    checkpoint_dir="checkpoints_textbugger",
    disable_stdout=True
)

print("[START] TextBugger Attack running...")
...
print("\n==================================================")
print("          TEXTBUGGER METRICS REPORT               ")
print("==================================================")
